...
if command -v fzf >/dev/null 2>&1; then
  ...
  export FZF_DEFAULT_OPTS="--height=40% --layout=reverse --preview-window=right:50%:wrap --color=fg:${fg},bg:${bg},hl:${purple},fg+:${fg},bg+:${bg_highlight},hl+:${purple},info:${blue},prompt:${cyan},pointer:${cyan},marker:${cyan},spinner:${cyan},header:${cyan}"
